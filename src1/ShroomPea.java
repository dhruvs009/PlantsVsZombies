...
public class ShroomPea{
    private static Image appearance= new Image("./public/shroomPea.png");
    ...
    public Timeline getShootTimeline(Pane pane,ShroomPea toShoot, int distX){
